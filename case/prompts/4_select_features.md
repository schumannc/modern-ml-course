Consider the data dictionary below. Identify which features should be excluded when training a machine learning model to predict the probability of default.
